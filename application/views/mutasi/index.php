<div class="main-content">
    <div class="topbar d-flex justify-content-between align-items-center">
        <h5><i class="fas fa-exchange-alt me-2"></i> Mutasi Masuk Sabun</h5>
        <a href="<?= base_url('mutasi/add') ?>" class="btn btn-primary">
    ...
    <div class="content-area">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white fw-bold">
                <i class="fas fa-history me-2"></i> Riwayat Mutasi Masuk
            </div>
                    ...
                    <table class="table table-bordered table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center text-success">+ <?= $row->jumlah ?></td>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('mutasi/edit/'.$row->id) ?>" class="btn btn-warning btn-sm" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="<?= base_url('mutasi/delete/'.$row->id) ?>" class="btn btn-danger btn-sm" 
                            ...
                            <tr>
                                <td colspan="8" class="text-center text-muted py-4">
                                    <i class="fas fa-inbox me-2"></i> Belum ada data mutasi masuk
                                </td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
