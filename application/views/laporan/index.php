<div class="main-content">
    ...
    <div class="content-area">
        <div class="row">
                ...
                <a href="<?= base_url('laporan/mutasi_masuk') ?>" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="fw-bold">Mutasi Masuk Chemical</h5>
                            <p class="text-muted mb-0">Rekapitulasi data masuknya Chemical</p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href="<?= base_url('laporan/pemakaian_shift') ?>" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="fw-bold">Pemakaian Chemical Per Shift</h5>
                ...
                <a href="<?= base_url('laporan/stok_sabun') ?>" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                        <div class="card-body text-center p-4">
                            ...
                            <h5 class="fw-bold">Stok Chemical</h5>
            ...
            <div class="col-md-6 mb-3">
                <a href="<?= base_url('laporan/pengambilan_linen') ?>" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                        <div class="card-body text-center p-4">
                            <i class="fas fa-file-alt fa-3x text-info mb-3"></i>
                            <h5 class="fw-bold">Laporan Pengambilan Linen</h5>
                            <p class="text-muted mb-0">Rekap semua transaksi pengambilan linen</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-md-6 mb-3">
                <a href="<?= base_url('laporan/pengembalian_linen') ?>" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                        <div class="card-body text-center p-4">
                            <i class="fas fa-file-alt fa-3x text-info mb-3"></i>
                            <h5 class="fw-bold">Laporan Pengembalian Linen</h5>
                            <p class="text-muted mb-0">Rekap semua transaksi pengembalian linen</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-md-6 mb-3">
                <a href="<?= base_url('laporan/rekapitulasi_pencucian') ?>" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                        <div class="card-body text-center p-4">
                            <i class="fas fa-file-alt fa-3x text-info mb-3"></i>
                            <h5 class="fw-bold">Laporan Hasil Pencucian Linen Bersih</h5>
                            <p class="text-muted mb-0">Rekap semua transaksi pencucian linen</p>
                        </div>
                    </div>
                </a>
            </div>
